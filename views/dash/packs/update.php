<div id="update" class="hidden">
    <div class="col-12 my-5">
        <h3 class="text-center border-top">- Modification de la formule -</h3>
    </div>
    ...
    <form action="" method="post" class="d-flex flex-column justify-content-center">
        ...
        <div class="formInputLine">
            <div class="mb-3 col-10 col-md-5 text-center">
                ...
                <input type="text" class="form-control" id="label" name="label" value="<?= $pack->label ?>">
                <p> <?= $error["label"] ?? '' ?></p>
            </div>
        ...
        <div class="formInputLine">
            <div class="mb-3 col-10 col-md-5 text-center">
                ...
                <input type="text" class="form-control" id="price" name="price" value="<?= $pack->price ?>">
                <p> <?= $error["duration"] ?? '' ?></p>
            </div>
        </div>
        ...
        <div class="formInputLine">
            <div class="mb-3 col-10 col-md-11 text-center">
                ...
                <input type="text" class="form-control" id="content" name="content" value="<?= $pack->content ?>">
                <p> <?= $error["content"] ?? '' ?></p>
            </div>
        </div>
